...
- [ ] Regenerate the real Shield through the CLI for v12/core and v14/core; compare identity, rarity, attunement, armor, descriptions, two Activities, uses/recovery, duration/concentration/range, damage, and prone linkage to source and locked schemas.
