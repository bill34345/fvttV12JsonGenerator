...
- Final aggregate `bun run ci:verify` exits 0 with `1300 pass / 0 fail` and `5159` assertions after independent-review remediation, coverage gate, 145-source anti-overfit audit, repository hygiene, locked dnd5e 5.3.3 reference verification, Web build, and offline Actor smoke.
