...
**Exact next action:** Execute Spell Resolver Task 11 real local Foundry acceptance and preserve the complete ignored evidence bundle before the Task 12 final gate/documentation pass.
