...
**Exact next action:** Execute M9 Task 2 by importing the regenerated v14/core Shield into the disposable project-local Foundry world, equipping it on a disposable Actor, exercising both Activities and the conditional prone effect, exporting/readback, and comparing source-relevant runtime fields to the CLI artifact.
